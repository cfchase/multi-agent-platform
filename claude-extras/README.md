...
- [docs/DEVELOPMENT.md](../docs/DEVELOPMENT.md) - Getting started guide
...
### Debugging
- [debugging-tips.md](./debugging-tips.md) - Troubleshooting common issues

### Architecture References
- Refer to `backend/CLAUDE.md` for backend architecture
- Refer to `frontend/CLAUDE.md` for frontend architecture
